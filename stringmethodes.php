...
if (isset($_POST['submit'])) {
    ...
    $naam = htmlspecialchars(ucfirst(strtolower($_POST['naam']))) ;
    $straat = htmlspecialchars(ucfirst(strtolower($_POST['straat'])))  ;
    $huisnummer = htmlspecialchars($_POST['huisnummer']) ;
    $postcode = htmlspecialchars($_POST['postcode']) ;
    $woonplaats = htmlspecialchars(ucfirst(strtolower($_POST['woonplaats']))) ;
